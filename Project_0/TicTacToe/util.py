class Node():
    def __init__(self, state, parent, depth, is_max_player, utility, action):
        self.state = state
        self.parent = parent
        self.action = action
...
class StackFrontier():
    def __init__(self):
        self.frontier = []
        self.explored_nodes = [] # set of movies that have already been added, purely for speed reasons
